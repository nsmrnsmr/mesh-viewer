...
void BoxObject::create(QOpenGLShaderProgram *shaderProgram)
{
...
{
    //we change the color of all vertices of the selected box to lightgray and the vertex colors of the selsected plane/face to light blue
